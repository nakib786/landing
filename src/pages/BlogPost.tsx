      ...
      <>
        ...
        <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-indigo-950 via-purple-900 to-pink-900">
          ...
          <div className="relative z-10 max-w-4xl mx-auto px-6 py-20 text-center">
            ...
            <Link to="/blog" className="text-purple-300 hover:text-purple-200">
              ← Back to Blog
            </Link>
          </div>
        </div>
      ...
      <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-indigo-950 via-purple-900 to-pink-900">
        ...
        <main className="relative z-10 max-w-4xl mx-auto px-6 py-12">
          ...
          <header className="mb-12">
            <div className="mb-4">
              <span className="px-4 py-2 bg-purple-500/30 text-purple-200 text-sm rounded-full">
                {post.category}
              </span>
            </div>
          ...
          {/* Article Content */}
          <article className="bg-white/5 backdrop-blur-sm p-8 rounded-2xl border border-white/20 mb-8">
          ...
          <div className="flex justify-between items-center pt-8 border-t border-white/20">
            <Link 
              to="/blog"
              className="px-6 py-3 bg-white/10 backdrop-blur-md rounded-lg border border-white/30 text-white hover:bg-white/20 transition-all"
            >
              ← All Posts
            </Link>
          </div>
